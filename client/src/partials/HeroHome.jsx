...
import OrToraImg1 from '../images/or_tora_main_pic.png';
import OrToraImg2 from '../images/or_tora_second_pic.png';

import waImage from '../images/wa_img.png'

import waimg from '../images/whatsapp.png'
import picimg from '../images/picture.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            ברוכים הבאים לבית הכנסת אור תורה
            </h1>
            <p className="text-xl text-gray-400 mb-8" data-aos="fade-up" data-aos-delay="200">
              אתם תמצאו באתר זה תמונות של בית הכנסת, שעות פעילות, אירועים, זמני חגים, זמני תפילות, ודרכים בכדיי לתרום לבית הכנסת ולגרום לצמיחתו וגדילתו
            ...
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div data-aos="fade-up" data-aos-delay="400">
                ...
                <img className="mx-auto" src={picimg}/>
                &nbsp;
                  צפיה בסרטונים ותמונות
                </a>
              </div>
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="https://wa.me/+972524847879">
                <img className="mx-auto" src={waimg}/>
                &nbsp;
                ליצירת קשר
                </a>
              </div>
          ...
          <div>
            <div className="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
              <img className="mx-auto" src={OrToraImg2} width="1024" height="504" alt="Hero" />
              <a
            ...
            <Modal id="modal" ariaLabel="modal-headline" show={videoModalOpen} handleClose={() => setVideoModalOpen(false)}>
              <div className="relative pb-9/16">
                <iframe className="absolute w-full h-full" src="https://www.youtube.com/embed/MwgINxTD8ow" title="Video" allowFullScreen></iframe>
              </div>
            </Modal>
