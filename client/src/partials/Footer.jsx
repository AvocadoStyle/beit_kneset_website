        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">ליצירת קשר עם יוצר האתר עדן בטלפון 054-787-1235</div>

              <div className="text-gray-400">הזכויות שמורות לאתר של עדן עבור לימוד סטודנטים ופיתוח פרוייקטים לחברות ולאנשים פרטיים, כל ניסיון של לקיחת סרטונים או חומרים מהאתר ללא רשות וללא מתן זכויות יוצרים הוא עבירה על החוק ©</div>
            </div>
